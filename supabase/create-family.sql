...
declare
  ...
  user_two uuid;
begin
  select id into user_one from auth.users where email='natanelsmadja0@gmail.com';
  select id into user_two from auth.users where email='nofaritskovich@gmail.com';
