...
export function LoginPage() {
  ...
  async function submit(event: FormEvent) {
    ...
    if (signInError) setError('האימייל או הסיסמה אינם נכונים')
    setLoading(false)
  }
    ...
    <div className="auth-page">
      <section className="auth-card">
        ...
        <form onSubmit={submit} className="form-stack">
          ...
          <label>סיסמה<input type="password" autoComplete="current-password" value={password} onChange={event => setPassword(event.target.value)} required /></label>
